...
int main( int argc, char** argv )
{
  ...
  P1->addToEntry(0,1,0.55);
  P1->addToEntry(0,2,0.2);
  P1->addToEntry(1,0,0.2);
  P1->addToEntry(1,1,0.4);
  P1->addToEntry(1,2,0.4);
  P1->addToEntry(2,0,0.3);
  P1->addToEntry(2,1,0.4);
  P1->addToEntry(2,2,0.3);
  trans.at(0) = P1;

  sparseMatrix *P2 = new sparseMatrix(3);
  P2->addToEntry(0,0,0.1);
  P2->addToEntry(0,1,0.2);
  P2->addToEntry(0,2,0.7);
  P2->addToEntry(1,0,0.0);
  P2->addToEntry(1,1,0.1);
  P2->addToEntry(1,2,0.9);
